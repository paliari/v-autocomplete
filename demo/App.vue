...
div(style="text-align: center;")
  ...
  v-autocomplete(:items="items" v-model='item', :get-label='getLabel', :min-len='0' @update-items='update', :component-item='tpl', @item-selected="itemSelected", @item-clicked="itemClicked")
  p Selected item:
  pre {{ item }}
