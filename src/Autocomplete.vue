<template lang="html">
  <div class="v-autocomplete">
    <div class="v-autocomplete-input-group" :class="{'v-autocomplete-selected': value}">
      <input type="search" v-model="searchText" :placeholder="placeholder" :class="inputClass" :id="inputId" :name="inputName"
...
export default {
  ...
  props: {
    ...
    inputId: {type: String, default: 'v-autocomplete-input'},
    inputName: {type: String, default: 'v-autocomplete-input'},
    disabled: {
      type: Boolean,
      default: false
    }
